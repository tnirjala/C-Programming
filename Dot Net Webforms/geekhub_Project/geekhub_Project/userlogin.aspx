                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="imgs/userlogo.png" width="100px" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvUserID" runat="server" ControlToValidate="TextBox1" ErrorMessage="User ID is required" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group spacing">
                                    <a href="usersignup.aspx"><input class="full-width-button-signup" id="Button2" type="button" value="Sign Up" /></a>
                                </div>
